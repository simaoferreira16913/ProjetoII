...
public class EncomendasFinancasController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
      try{
        ...
        try {
            pst = conn.prepareStatement("SELECT e.id_encomenda_c,e.qt_tipo_sal,e.qt_tipo_sem,e.qt_tipo_alho,e.id_cliente, cliente.nome FROM ENCOMENDA_CLIENTE e INNER JOIN Cliente ON e.id_cliente = Cliente.id_cliente WHERE ESTADO = 'Concluido'");
